                    ...
                    <div className="container py-5">
                        <div className="row justify-content-center">
                            <div className="col-md-6 text-center">
                                ...
                                <h1 className={s.header}>Technicals</h1>
                                <p className={s.paragraph}>
                                ...
                                <h2 className={s.header2} id={"RealTimeCommunication"}>Real time communication</h2>
                                <p className={s.paragraph}>
                                ...
                                <h2 className={s.header2} id={"Next.JS"}>Using Next.JS</h2>
                                <p className={s.paragraph}>
                                ...
                                <h2 className={s.header2} id={"Interfaces"}>Changing everything to interfaces</h2>
                                <p className={s.paragraph}>
